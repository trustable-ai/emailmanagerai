...
import { Mail, ShieldCheck, Sparkles, Zap } from "lucide-react";
...
export function Login() {
  const { loginWithGoogle, connecting, connectStep } = useAuth();
  const steps = ["Authorizing with Google", "Granting Gmail scopes", "Connecting mailbox"];
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      >
        ...
        <p className="mt-6 text-center text-[11px] leading-relaxed text-muted-foreground">
          Temporary Google OAuth sign-in connects your Gmail account. We never
          store your password. OAuth scopes can be revoked anytime.
        </p>
      </motion.div>
    </div>
  );
